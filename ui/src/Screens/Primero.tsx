...
const Primero = () => {
  ...
  if(bool2 === true){
        ...
        firebase.database().ref('users/' + userKey.uid + '/universidad').once('value').then(function(snapshot)
    {
        ...
        firebase.database().ref('asignaturas/'+ universidad + '/' + grado + '/codigosPrimero/').once('value').then(function(snapshot)
      {
       var cont = 0;
       var aux1 = [""]
       var aux2 = [""]
  ...
  {(bool2 === true) &&
   ...
   <Backdrop className={classes.backdrop} open={bool2}>
    ...
    {(bool2 === false) &&
      <>
    <Asignatura id={asignaturasCod[0]} nombre={asignaturasNom[0]} curso={"primero"} />
    <Asignatura id={asignaturasCod[1]} nombre={asignaturasNom[1]} curso={"primero"} />
    <Asignatura id={asignaturasCod[2]} nombre={asignaturasNom[2]} curso={"primero"} />
    <Asignatura id={asignaturasCod[3]} nombre={asignaturasNom[3]} curso={"primero"} />
    <Asignatura id={asignaturasCod[4]} nombre={asignaturasNom[4]} curso={"primero"} />
    <Asignatura id={asignaturasCod[5]} nombre={asignaturasNom[5]} curso={"primero"} />
    <Asignatura id={asignaturasCod[6]} nombre={asignaturasNom[6]} curso={"primero"} />
    <Asignatura id={asignaturasCod[7]} nombre={asignaturasNom[7]} curso={"primero"} />
    <Asignatura id={asignaturasCod[8]} nombre={asignaturasNom[8]} curso={"primero"} />
    <Asignatura id={asignaturasCod[9]} nombre={asignaturasNom[9]} curso={"primero"} />
</>}
      </Grid>
